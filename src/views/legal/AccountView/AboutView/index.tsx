...
<Container maxWidth="lg">
        ...
        >
          ...
          <p>
                ...
                USE THE SITE. <br />
                <br />
                <strong className={classes.heading}>Important Definitions </strong>
                <br />
                ...
                <br />
                <br />
                <strong className={classes.heading}>Children under age 18</strong>
                <br />
                ...
                <br />
                <br />
                <strong  className={classes.heading}>The Uses of the Data Collected by TelaCoach </strong>
                <br />
                ...
                <br />
                <br />
                <strong className={classes.heading}>Portable Electronic Devices </strong>
                <br />
                ...
                <br />
                <br />
                <strong className={classes.heading}>Your Use of Your Personal Data </strong>
                <br />
                ...
                <br />
                <strong  className={classes.heading}>Disputes </strong>
                <br />
                ...
                <br />
                <br />
                <strong className={classes.heading}>Social Networks and TelaCoach </strong>
                <br />
                ...
                <br />
                <strong className={classes.heading}>Cookies on Telacoach </strong>
                <br />
