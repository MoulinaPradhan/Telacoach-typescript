...
<Container maxWidth="lg">
        ...
        >
          ...
          <p>
                ...
                <br />
                <br />
                <strong>Children under age 18</strong>
                <br />
                ...
                <br />
                <br />
                <strong>The Uses of the Data Collected by TelaCoach </strong>
                <br />
                ...
                <br />
                <br />
                <strong>Portable Electronic Devices </strong>
                <br />
                ...
                <br />
                <br />
                <strong>Social Networks and TelaCoach </strong>
                <br />
                ...
                <br />
                <strong>Cookies on Telacoach </strong>
                <br />
