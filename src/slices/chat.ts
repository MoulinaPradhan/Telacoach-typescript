...
const slice = createSlice({
  ...
  reducers: {
    ...
    addChat(state: ChatState, action: PayloadAction<{ threadId: string; message: string }>) {
...
export const addNewChat = (threadId, message): AppThunk => async (dispatch) => {
  dispatch(slice.actions.addChat({ threadId, message }));
};
