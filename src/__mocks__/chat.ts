    ...
    messages: [
      {
        ...
        attachments: [],
        body: 'Hey, nice sessions! I really liked the one in fitness. What\'s your quote on kinda similar sessions?',
        contentType: 'text',
        createdAt: moment()
          .subtract(10, 'hours')
          .toDate()
      ...
      },
      {
        ...
        attachments: [],
        body: 'Yeah right, I am liking them too.',
        contentType: 'text',
        createdAt: moment()
          .subtract(2, 'hours')
          .toDate()
      ...
      },
      {
        ...
        attachments: [],
        body: 'Well it\'s a really easy one, I\'m sure we can make it.',
        contentType: 'text',
        createdAt: moment()
          .subtract(5, 'minutes')
          .toDate()
      ...
      //   attachments: [],
      //   body: '/static/images/telacoach/Fitness-coach.jpg',
      //   contentType: 'image',
      //   createdAt: moment()
      //     .subtract(1, 'minute')
      //     .toDate()
    ...
    messages: [
      {
        ...
        attachments: [],
        body: 'Hey, how the fitness session is going?',
        contentType: 'text',
        createdAt: moment()
          .subtract(6, 'minutes')
          .toDate()
