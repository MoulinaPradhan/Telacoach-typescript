      ...
      comments: [
        {
          ...
          createdAt: moment()
            ...
            .toDate()
            .getTime(),
          message: 'Im already excited for this.'
        },
        {
  ...
  const posts: Post[] = [
    {
      ...
      comments: [
        {
          ...
          createdAt: moment()
            ...
            .toDate()
            .getTime(),
          message: 'I\'ve been taking fitness session for the past two weeks and it\'s quite amazing. I love it.'
        }
      ],
      createdAt: moment()
        .subtract(16, 'minutes')
      ...
      // isLiked: true,
      likes: 1,
      message: 'Hey guys! What\'s your favorite session?'
    },
    {
      id: '5e887faca2b7a1ddce01221a',
      author: {
      ...
      comments: [
        {
          ...
          createdAt: moment()
            ...
            .toDate()
            .getTime(),
          message: 'I\'m already excited for this.'
        },
        {
          id: '5e887fc759bebe8d5d54a2e5',
          author: {
          ...
          createdAt: moment()
            ...
            .toDate()
            .getTime(),
          message: 'Hmm, even I\'m too, this is going to be a great session.'
        }
      ],
      createdAt: moment()
        .subtract(4, 'hours')
      ...
      likes: 24,
      media: '/static/images/posts/post_1.png',
      message: 'Just preparing myself for another cool session, what-cha thinkin?'
    },
    {
      id: '5e887faf03e78a5359765636',
      author: {
      ...
      comments: [
        ...
        },
        {
          ...
          createdAt: moment()
            ...
            .toDate()
            .getTime(),
          message: 'Oh. This session is really good.'
        }
      ],
      createdAt: moment()
        .subtract(7, 'hours')
      ...
      // isLiked: false,
      likes: 65,
      message: 'As a human being, you are designed in a way that makes you incapable of experiencing any positive emotion unless you set an aim and progress towards it. What makes you happy is not, in fact, attaining it, but making progress towards it. This I have learn\'t from "Motivational Session". '
    }
  ];
