...
interface AuthContextValue extends AuthState {
  ...
  logout: () => void;
  register: (email: string, name: string, password: string, userType: UserType) => Promise<void>;
}
...
export const AuthProvider: FC<AuthProviderProps> = ({ children }) => {
  ...
  const register = async (email: string, name: string, password: string, userType: UserType) => {
